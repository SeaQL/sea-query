...
fn explain_postgres_select_with_options() {
    assert_eq!(
        ...
        r#"EXPLAIN (ANALYZE, VERBOSE FALSE, COSTS, SETTINGS FALSE, GENERIC_PLAN, BUFFERS, SERIALIZE TEXT, WAL, TIMING FALSE, SUMMARY, MEMORY, FORMAT JSON) SELECT "character" FROM "character""#
    );
}
