...
fn create_2() {
    assert_eq!(
        Table::create()
            .table(Font::Table)
            .col(ColumnDef::new(Font::Id).integer().not_null())
        ...
        [
            r#"CREATE TABLE `font` ("#,
            r#"`id` INT64 NOT NULL,"#,
            r#"`name` STRING NOT NULL,"#,
            r#"`variant` STRING(255) NOT NULL,"#,
            r#"`language` STRING(255) NOT NULL"#,
            r#")"#,
        ]
        .join(" ")
    );
...
// Foreign key constraints are not supported in BigQuery.
#[test]
...
fn create_3() {
    assert_eq!(
        ...
        [
            ...
            r#"`id` INT64 NOT NULL,"#,
            r#"`font_size` INT64 NOT NULL,"#,
            r#"`character` STRING(255) NOT NULL,"#,
            r#"`size_w` STRING NOT NULL,"#,
            r#""size_h" STRING NOT NULL,"#,
            r#"`font_id` INT64 DEFAULT NULL,"#,
...
fn create_6() {
    assert_eq!(
        ...
        [
            r#"CREATE TABLE `glyph` ("#,
            r#"`id` INT64 NOT NULL ANYTHING I WANT TO SAY"#,
            r#")"#,
        ]
        .join(" ")
    );
...
fn create_7() {
    assert_eq!(
        Table::create()
            .table(Glyph::Table)
            .col(ColumnDef::new(Glyph::Aspect).interval_bq().not_null())
            .to_string(BigQueryQueryBuilder),
        [
            r#"CREATE TABLE `glyph` ("#,
...
fn alter_1() {
    assert_eq!(
        Table::alter()
            ...
            .to_string(BigQueryQueryBuilder),
        r#"ALTER TABLE `font` ADD COLUMN `new_col` INT64 NOT NULL DEFAULT 100"#
    );
}
...
fn alter_2() {
    assert_eq!(
        ...
        [
            r#"ALTER TABLE `font`"#,
            r#"ALTER COLUMN `new_col` SET DATA TYPE INT64,"#,
...
fn alter_6() {
    Table::alter().to_string(BigQueryQueryBuilder);
}
...
fn alter_7() {
    assert_eq!(
        Table::alter()
            ...
            .to_string(BigQueryQueryBuilder),
        r#"ALTER TABLE `font` ADD COLUMN `new_col` INT64, RENAME COLUMN `name` TO `name_new`"#
    );
}
...
#[test]
#[should_panic(expected = "BigQuery doesn't support changing to REQUIRED")]
fn alter_9() {
    assert_eq!(
        Table::alter()
            .table(Glyph::Table)
