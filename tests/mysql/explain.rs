...
#[test]
fn explain_mysql_table() {
    assert_eq!(
        ExplainStatement::table(ExplainTable::new(Char::Table)).to_string(MysqlQueryBuilder),
        "EXPLAIN `character`"
    );
    assert_eq!(
        ExplainStatement::table(ExplainTable::new(Char::Table).column("size"))
            .to_string(MysqlQueryBuilder),
        "EXPLAIN `character` `size`"
    );
    assert_eq!(
        ExplainStatement::table(ExplainTable::new(Char::Table).wildcard("size_%"))
            .to_string(MysqlQueryBuilder),
        "EXPLAIN `character` 'size_%'"
    );
}
...
fn explain_mysql_describe_table_column() {
    assert_eq!(
        ExplainStatement::table(ExplainTable::new(Char::Table).column(Char::SizeW))
            .to_string(MysqlQueryBuilder),
